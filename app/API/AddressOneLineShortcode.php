...
class AddressOneLineShortcode
{
    ...
    public function __construct()
    {
        ...
        add_shortcode('wp_simple_one_line_address', array($this, 'renderView'));
    ...
    public function renderView($options)
    {
        ...
        $rv = $this->location_data['address'] . ' ';

        if(!empty($this->location_data['address_2']))
        {
            $rv .= $this->location_data['address_2'] . ' ';
        }
