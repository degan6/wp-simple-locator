	...
	*/
	private function setLocationData()
	{
		...
		if ( $this->post_type == 'location' ){
            ...
            $this->location_data['hours_mf_open'] = get_post_meta( get_the_id(), 'wpsl_hours_mf_open', true);
            $this->location_data['hours_mf_close'] = get_post_meta( get_the_id(), 'wpsl_hours_mf_close', true);
            $this->location_data['hours_sat_open'] = get_post_meta( get_the_id(), 'wpsl_hours_sat_open', true);
            ...
            $this->location_data['hours_sat_is_closed'] = get_post_meta(get_the_id(), 'wpsl_hours_sat_is_closed', true);
            $this->location_data['hours_mf_is_closed'] = get_post_meta(get_the_id(), 'wpsl_hours_mf_is_closed', true);
            $this->location_data['hours_sun_is_closed'] = get_post_meta(get_the_id(), 'wpsl_hours_sun_is_closed', true);
		}
	}
